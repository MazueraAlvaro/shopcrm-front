...
module.exports = {
	collectCoverageFrom: ["src/**/*.{ts,tsx}", "!**/*.stories.{ts,tsx}", "!**/*.stub.ts", "!**/*.styles.ts", "!**/*.d.ts", "!**/index.ts"],
	...
	moduleNameMapper: {
		".+\\.(jpg|jpeg|png|gif|eot|otf|webp|svg|ttf|woff|woff2|mp4|webm|wav|mp3|m4a|aac|oga)$": "<rootDir>/__mocks__/binaryFile.js",
